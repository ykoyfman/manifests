...
func writeProfilesOverlaysOpenshift(th *KustTestHarness) {
	th.writeK("/manifests/profiles/overlays/openshift", `
bases:
- ../../base
images:
...
func TestProfilesOverlaysOpenshift(t *testing.T) {
	th := NewKustTestHarness(t, "/manifests/profiles/overlays/openshift")
	writeProfilesOverlaysOpenshift(th)
	...
	targetPath := "../profiles/overlays/openshift"
	fsys := fs.MakeRealFS()
